...
namespace DataAccess.Repositories
{
	public class OrderRepository : IOrderRepository
	{
		...
		public (string, string, int) AddOrder(long userId, List<ShopProductRequestAddOrderDTO> orders, bool isUseCoin) => OrderDAO.Instance.AddOrder(userId, orders, isUseCoin);
