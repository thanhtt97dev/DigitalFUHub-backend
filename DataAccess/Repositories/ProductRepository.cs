...
namespace DataAccess.Repositories
{
	public class ProductRepository : IProductRepository
	{
		...
		public int GetNumberProductByStatusId(int productStatusId) => ProductDAO.Instance.GetNumberProductByStatusId(productStatusId);

		public List<Product> GetProductsForAdmin(string shopName, string productName, int productCategory, int soldMin, int soldMax, int productStatusId, int page) => ProductDAO.Instance.GetProductsForAdmin(shopName, productName, productCategory, soldMin, soldMax, productStatusId, page);
