...
namespace DataAccess.IRepositories
{
	public interface IProductRepository
	{
		...
		int GetNumberProductByStatusId(int productStatusId);
		List<Product> GetProductsForAdmin(string shopName, string productName, int productCategory, int soldMin, int soldMax, int productStatusId, int page);
	}
}
