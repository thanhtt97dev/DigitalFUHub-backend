...
namespace BusinessObject.Migrations
{
    ...
    [Migration("20240129152417_version-3")]
            ...
            modelBuilder.Entity("BusinessObject.Entities.BusinessFee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BusinessFeeId = 1L,
                            Fee = 5L,
                            StartDate = new DateTime(2024, 1, 29, 22, 24, 16, 159, DateTimeKind.Local).AddTicks(769)
                        });
                });
            ...
            modelBuilder.Entity("BusinessObject.Entities.FeedbackBenefit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Coin = 50L,
                            StartDate = new DateTime(2024, 1, 29, 22, 24, 16, 159, DateTimeKind.Local).AddTicks(782)
                        });
                });
            ...
            modelBuilder.Entity("BusinessObject.Entities.ShopRegisterFee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fee = 50000L,
                            StartDate = new DateTime(2024, 1, 29, 22, 24, 16, 159, DateTimeKind.Local).AddTicks(747)
                        });
                });
