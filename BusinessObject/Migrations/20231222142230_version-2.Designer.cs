...
namespace BusinessObject.Migrations
{
    ...
    [Migration("20231222142230_version-2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessObject.Entities.BusinessFee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BusinessFeeId = 1L,
                            Fee = 5L,
                            StartDate = new DateTime(2023, 12, 22, 21, 22, 29, 447, DateTimeKind.Local).AddTicks(7018)
                        });
                });
            ...
            modelBuilder.Entity("BusinessObject.Entities.DepositTransaction", b =>
                {
                    ...
                    b.Property<int>("DepositTransactionStatusId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BusinessObject.Entities.Feedback", b =>
                {
                    ...
                    b.Property<long>("FeedbackBenefitId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BusinessObject.Entities.FeedbackBenefit", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("FeedbackBenefitId"), 1L, 1);
                    ...
                    b.HasData(
                        new
                        {
                            FeedbackBenefitId = 1L,
                            Coin = 50L,
                            StartDate = new DateTime(2023, 12, 22, 21, 22, 29, 447, DateTimeKind.Local).AddTicks(7043)
                        });
                });
            ...
            modelBuilder.Entity("BusinessObject.Entities.ReasonReportProduct", b =>
                {
                    b.Property<int>("ReasonReportProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReasonReportProductId"), 1L, 1);

                    b.Property<string>("EnExplanation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ViExplanation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasKey("ReasonReportProductId");

                    b.ToTable("ReasonReportProduct");

                    b.HasData(
                        new
                        {
                            ReasonReportProductId = 1,
                            EnExplanation = "",
                            EnName = "",
                            ViExplanation = "Sản phẩm bị cấm theo quy định của Pháp luật hoặc nằm trong danh mục bị hạn chế trên FuDigitalHub",
                            ViName = "Sản phẩm bị cấm buôn bán (động vật hoang dã, 18+,...)"
                        },
                        new
                        {
                            ReasonReportProductId = 2,
                            EnExplanation = "",
                            EnName = "",
                            ViExplanation = "Hình ảnh sản phẩm chưa rõ ràng (quá nhỏ, không nhìn thấy toàn bộ sản phẩm hoặc bị che mờ các thông tin cần thiết)",
                            ViName = "Hình ảnh sản phẩm không rõ ràng"
                        },
                        new
                        {
                            ReasonReportProductId = 3,
                            EnExplanation = "",
                            EnName = "",
                            ViExplanation = "Sản phẩm có hình ảnh, nội dung phản cảm hoặc có thể gây phản cảm",
                            ViName = "Sản phẩm có hình ảnh, nội dung phản cảm hoặc có thể gây phản cảm"
                        },
                        new
                        {
                            ReasonReportProductId = 4,
                            EnExplanation = "",
                            EnName = "",
                            ViExplanation = "Thông tin sản phẩm có chứa yêu cầu bất hợp pháp: đặt cọc, chuyển khoản, gửi lại tiền thừa trong gói hàng, hoặc giao dịch ngoài DigitabFuHub, v.v...",
                            ViName = "Sản phẩm có dấu hiệu lừa đảo"
                        },
                        new
                        {
                            ReasonReportProductId = 5,
                            EnExplanation = "",
                            EnName = "",
                            ViExplanation = "Tên sản phẩm hoàn toàn khác với hình ảnh. Người bán cần sửa lại tên phù hợp với hình ảnh sản phẩm.",
                            ViName = "Tên sản phẩm (Name) không phù hợp với hình ảnh sản phẩm"
                        },
                        new
                        {
                            ReasonReportProductId = 6,
                            EnExplanation = "",
                            EnName = "",
                            ViExplanation = "Người bán có dấu hiệu tạo đơn ảo để tăng số lượng đơn hàng và đánh giá",
                            ViName = "Sản phẩm có dấu hiệu tăng đơn ảo"
                        },
                        new
                        {
                            ReasonReportProductId = 7,
                            EnExplanation = "",
                            EnName = "",
                            ViExplanation = "Sản phẩm vi phạm quy định khác của DigitabFuHub",
                            ViName = "Khác"
                        });
                });
            ...
            modelBuilder.Entity("BusinessObject.Entities.ReportProduct", b =>
                {
                    b.Property<long>("ReportProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ReportProductId"), 1L, 1);
                    ...
                    b.Property<int>("ReportProductStatusId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReasonReportProductId");

                    b.HasIndex("ReportProductStatusId");
            ...
            modelBuilder.Entity("BusinessObject.Entities.ReportProductStatus", b =>
                {
                    b.Property<int>("ReportProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ReportProductId"), 1L, 1);
            ...
            modelBuilder.Entity("BusinessObject.Entities.Shop", b =>
                {
                    ...
                    b.Property<long>("ShopRegisterFeeId")
                        .HasColumnType("bigint");

                    b.HasKey("UserId");

                    b.HasIndex("ShopRegisterFeeId");

                    b.ToTable("Shop");
                });

            modelBuilder.Entity("BusinessObject.Entities.ShopRegisterFee", b =>
                {
                    b.Property<long>("ShopRegisterFeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("ShopRegisterFeeId"), 1L, 1);
                    ...
                    b.HasKey("ShopRegisterFeeId");

                    b.ToTable("ShopRegisterFee");

                    b.HasData(
                        new
                        {
                            ShopRegisterFeeId = 1L,
                            Fee = 50000L,
                            StartDate = new DateTime(2023, 12, 22, 21, 22, 29, 447, DateTimeKind.Local).AddTicks(6980)
                        });
                });

            modelBuilder.Entity("BusinessObject.Entities.Slider", b =>
                {
                    b.Property<long>("SliderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("SliderId"), 1L, 1);
            ...
            modelBuilder.Entity("BusinessObject.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsConfirm = true,
                            IsOnline = false,
                            LastTimeOnline = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Password = "123",
                            RoleId = 1L,
                            SignInGoogle = false,
                            Status = true,
            ...
            modelBuilder.Entity("BusinessObject.Entities.WishList", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BusinessObject.Entities.WithdrawTransactionStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            WithdrawTransactionStatusId = 1L,
                            Name = "In processing"
                        },
                        new
                        {
                            WithdrawTransactionStatusId = 2L,
                            Name = "Paid"
                        },
                        new
                        {
                            WithdrawTransactionStatusId = 3L,
                            Name = "Reject"
                        },
                        new
                        {
                            WithdrawTransactionStatusId = 4L,
                            Name = "Cancel"
                        });
                });
            ...
            modelBuilder.Entity("BusinessObject.Entities.ReportProduct", b =>
                {
                    ...
                    b.HasOne("BusinessObject.Entities.ReasonReportProduct", "ReasonReportProduct")
                        .WithMany("ReportProducts")
                        .HasForeignKey("ReasonReportProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BusinessObject.Entities.ReportProductStatus", "ReportProductStatus")
                        .WithMany("ReportProducts")
                        .HasForeignKey("ReportProductStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ReasonReportProduct");

                    b.Navigation("ReportProductStatus");
            ...
            modelBuilder.Entity("BusinessObject.Entities.Shop", b =>
                {
                    b.HasOne("BusinessObject.Entities.ShopRegisterFee", "ShopRegisterFee")
                        .WithMany("Shops")
                        .HasForeignKey("ShopRegisterFeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
