    ...
    public partial class updateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, null, 5L, new DateTime(2023, 10, 19, 16, 34, 19, 842, DateTimeKind.Local).AddTicks(1902) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 100, null, new DateTime(2023, 10, 19, 16, 34, 19, 842, DateTimeKind.Local).AddTicks(1929) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, "In processing" });

            migrationBuilder.InsertData(
                table: "WithdrawTransactionStatus",
                columns: new[] { "WithdrawTransactionStatusId", "Name" },
                values: new object[] { 2L, "Paid" });

            migrationBuilder.InsertData(
                table: "WithdrawTransactionStatus",
                columns: new[] { "WithdrawTransactionStatusId", "Name" },
                values: new object[] { 3L, "Reject" });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "UserId", "AccountBalance", "Avatar", "Coin", "Email", "Fullname", "IsConfirm", "IsOnline", "LastTimeOnline", "Password", "RoleId", "SignInGoogle", "Status", "TwoFactorAuthentication", "Username" },
                values: new object[] { 1L, 0L, "", 0L, "", "Admin", true, false, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "123", 1L, false, true, false, "admin" });
